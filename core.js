...
document.TotalCount = '18';
document.TotalAllCount = '158';
...
function addToCompare(n, t, i, r = false) {
    ...
    if (t != undefined && t.preventDefault(),
        isFirstSS || showCompare(),
        c = 3,
        closeTipCompare(),
        closeCompareBox(),
        $(".stickcompare label.error").hide(),
        d = "<li class=formsg><a href='javascript:' class='cp-plus cp-plus_new' onclick='OpenPopup(this)'><i class='icImageCompareNew'><\/i><p>Thêm sản phẩm<\/p><\/a>",
        n <= 0)
        return (idcompare == undefined || idcompare.length <= 0) && (createCookie("ck_idcompare", "", 30),
            $("#ss-now").hide()),
            !1;
    if (idcompare.indexOf(n) >= 0)
        return r || cacheError("already"),
            u = $(".listproduct *[data-id=" + n + "]").first(),
            (u == undefined || u.length <= 0) && (u = $(".compare-popup *[data-id=" + n + "]").first()),
            u.find("a.item-ss").removeClass("active").html("<i><\/i> So sánh"),
            e = $(".box02 *[data-id=" + n + "]").first(),
            e != undefined && e.length > 0 && e.removeClass("active").html("<i class='icondetail-sosanh'><\/i> So sánh"),
            removeCompare(n),
            ClosePopup(),
            countCompare(),
            $(".stickcompare").length > 0 && $(".stickcompare").is(":hidden") == !1 && $("#ss-now").hide(),
            !1;
    if (v = !1,
        $(".listcompare li.formsg").remove(),
        o = '<li id={id}><a href="javascript:void(0)" id="{id}"><img src="{image}" alt=""><h3>{manu}<\/h3><\/a><span class="remove-ic-compare" onclick="removeCompare({id},event);"><i class="iconcate-closess"><\/i><\/span><\/li>',
        u = $(".listproduct *[data-id=" + n + "]").first(),
        (u == undefined || u.length <= 0) && (u = $(".compare-popup *[data-id=" + n + "]").first()),
        u.find("a.item-ss").addClass("active").html("<i><\/i> Đã thêm so sánh"),
        e = $(".box02 *[data-id=" + n + "]").first(),
        e != undefined && e.length > 0 && e.addClass("active").html("<i class='icondetail-sosanh'><\/i> Đã thêm so sánh"),
        u != undefined && u.length > 0 && (v = !0),
        i !== undefined ? (u = $(i),
            f = u.data("href"),
            s = u.data("img"),
            l = u.data("name")) : (f = u.find("a").attr("href") == "javascript:;" ? u.data("url") : u.find("a").attr("href"),
                s = u.find(".item-img img").attr("src"),
                l = u.find("a > h3").text() != "" ? u.find("a > h3").text() : u.find(".item-info h3").text(),
                u.find("a > h3").attr("title") !== undefined && u.find("a > h3").attr("title") !== "" && (l = u.find("a > h3").attr("title")),
                (s == undefined || s == "undefined") && (s = u.find(".item-img img").attr("data-src"))),
        y = f.indexOf("?"),
        f = f.substring(0, y != -1 ? y : f.length),
        p = "",
        nt = urlcompare.length > 0 ? urlcompare[0].slice(1, urlcompare[0].slice(1, -1).indexOf("/") + 1) : "",
        f.charAt(0) == "/" && (w = f.replace(f.charAt(0), "").split("/"),
            w.length == 2 && (p = w[0])),
        urlcompare.length > 0 && nt.indexOf(p) < 0)
        return $(".listcompare li").each(function () {
            ...
            addToCompare(n, t, i),
            !1;
    if (v && localStorage.setItem("CompareCateName", document.cateName),
        idcompare.length >= c)
        return $(".listcompare li.formsg").remove(),
            cacheError("full"),
            u.parent("ul.pro-compare").length <= 0 && u.find("a.item-ss").removeClass("active").html("<i><\/i> So sánh"),
            e = $(".box02 *[data-id=" + n + "]").first(),
            e != undefined && e.removeClass("active").html("<i class='icondetail-sosanh'><\/i> So sánh"),
            !1;
    if (g = document.cateName !== undefined ? document.cateName : "",
        idcompare.push(parseInt(n)),
        urlcompare.push(f.indexOf("/") === 0 ? f : "/" + f),
        o = o.replace(/{id}/g, n),
        o = o.replace("{image}", s),
        o = o.replace("{manu}", l),
        $(".stickcompare").length ? $(".stickcompare").addClass("spaceInDown").show() : (a = document.isDesktop == !0 ? "<div class='stickcompare stickcompare_new cp-desktop'><label class='error'><\/label><a href='javascript:;' onclick='clearCompare(event);' class='clearall'><i class='iconcate-closess'><\/i>Thu gọn<\/a><ul class='listcompare' data-catename='" + document.cateName + "'><\/ul><\/div> " : "<div class='stickcompare stickcompare_new'><label class='error'><\/label><ul class='listcompare' data-catename='" + document.cateName + "'><\/ul><\/div>",
            a = a.replace("{catename}", g.toLowerCase()),
            $("body").append(a)),
        $(".stickcompare").find("ul").append(o),
        $(".compare-box").length > 0 && $(".compare-box > ul > li").length == 2 && (b = $(".compare-box > ul").html(),
            console.log(b),
            $(".compare-box").remove(),
            $(".stickcompare").find("ul").append(b)),
        idcompare.length < c)
        for (k = 0; k <= c; k++)
            $(".stickcompare .listcompare li").length < c && $(".stickcompare .listcompare").append(d);
    else
        idcompare.length == 3 && closeAddCmp();
    return h = !1,
        ...
        isFirstSS = !1,
        $(".closecompare").remove(),
        document.isDesktop == !0 ? $(".stickcompare").append('<div class="closecompare"><a href="javascript:;" onclick="' + (h ? "" : "doCompare();") + '"class="doss' + (h ? " prevent" : "") + '">So sánh ngay<\/a><a href="javascript:;" onclick="RemoveAllIdCompare()" class="txtremoveall">Xóa tất cả sản phẩm<\/a><\/div>') : $(".stickcompare").append('<div class="closecompare"><a href="javascript:;" onclick="clearCompare(event);" class="clearall">Thu gọn<\/a><a href="javascript:;" onclick="' + (h ? "" : "doCompare();") + '"class="doss' + (h ? " prevent" : "") + '">So sánh ngay<\/a><\/div>'),
...
function removeCompare(n, t) {
    ...
    if (t !== undefined && t.preventDefault(),
        r = 3,
        $(".listcompare li.formsg").remove(),
        e = "<li class=formsg><a href='javascript:' class='cp-plus cp-plus_new' onclick='OpenPopup(this)'><i class='icImageCompareNew'><\/i><p>Thêm sản phẩm<\/p><\/a>",
        idcompare.indexOf(n) >= 0) {
        for (urlcompare.splice(idcompare.indexOf(n), 1),
            ...
            u != undefined && u.removeClass("active").html("<i class='icondetail-sosanh'><\/i> So sánh"),
            idcompare.length == 0 ? clearCompare() : idcompare.length < 2 && $(".stickcompare").find(".boxcompare").remove(),
            i = !1,
            idcompare.length < 2 && (i = !0),
            $(".stickcompare").find("li#" + n).remove(),
            $(".closecompare").remove(),
            f = 0; f <= r; f++)
            $(".stickcompare .listcompare li").length < r && $(".stickcompare .listcompare").append(e);
        $(".stickcompare label.error").removeAttr("style").hide();
        document.isDesktop == !0 ? $(".stickcompare").append('<div class="closecompare"><a href="javascript:;" onclick="' + (i ? "" : "doCompare();") + '"class="doss' + (i ? " prevent" : "") + '">So sánh ngay<\/a><a href="javascript:;" onclick="RemoveAllIdCompare()" class="txtremoveall">Xóa tất cả sản phẩm<\/a><\/div>') : $(".stickcompare").append('<div class="closecompare"><a href="javascript:;" onclick="clearCompare(event);" class="clearall">Thu gọn<\/a><a href="javascript:;" onclick="' + (i ? "" : "doCompare();") + '"class="doss' + (i ? " prevent" : "") + '">So sánh ngay<\/a><\/div>')
    }
    return !1
}
function clearCompare() {
    $(".stickcompare").hide();
    document.isDesktop == !0 && ($(".overlay").hide(),
        $(".overlay").removeClass("v2"));
    $(".stickcompare label.error").removeAttr("style").hide();
    var n = getCookie("ck_idcompare")
        , t = n != "" && n != null ? n.split(",") : [];
    t.length > 0 ? ($("#ss-now").show(),
        document.isDesktop == !1 && document.productId > 0 && $("#ss-now").hide()) : $("#ss-now").hide()
}
function showCompare(n, t, i = false) {
    var r, u;
    $(".stickcompare").length <= 0 && (r = getCookie("ck_idcompare"),
        r !== "" && r !== null ? getCompareListByListID(r, n > 0 ? n : 0, t) : n > 0 && t !== undefined ? getCompareListByListID(n, 0, t, i) : $(".box02__right").length > 0 && (u = $(".box02__right").data("id"),
            u > 0 && ($(".stickcompare").length <= 0 ? showCompare(u, "div.box02__right", !0) : addToCompare(u, event, "div.box02__right"))));
    $(".stickcompare").show();
...
function doCompare(n) {
    var t = document.cateUrl, i, r, u;
    return t !== "" && urlcompare.length >= 2 ? (urlcompare[0].indexOf(t) < 0 && urlcompare[1].indexOf(t) < 0 && (t = urlcompare[0].slice(1, urlcompare[0].slice(1, -1).indexOf("/") + 1)),
        i = "itm_source=so-sanh-trang-nganh-hang",
        n !== undefined && n == !0 && (i = "itm_source=goi-y-so-sanh-trang-nganh-hang"),
        r = "",
        r = idcompare.length == 3 ? "?productid=" + idcompare[2] + "&" + i : "?" + i,
        u = "/" + t + "/" + urlcompare[0].replace("/" + t + "/", "") + "-vs-" + urlcompare[1].replace("/" + t + "/", "") + r,
        $(".stickcompare").remove(),
        $(".box02__right").length <= 0 && loadingRedirect(),
        window.location = u,
        idcompare = [],
        urlcompare = []) : cacheError("least"),
        !1
}
...
function closeCompareBox() {
    $(".compare-box").length > 0 && ($(".compare-box").remove(),
        $("#notifychatmsg").show())
}
function callCompareSuggestion(n) {
    typeof showSuggest != "undefined" && showSuggest == "true" && (n == undefined || n === !0) && ($("#lstp .cate > li").each(function () {
        var n = parseInt($(this).find("a").first().data("pid"));
        n > 0 && addToCompareAuto(n)
    }),
        idcompare.length >= 2 && $(window).scrollTop() > 100 ? $(".compare-box").show("slow") : $(".compare-box").hide())
}
function addToCompareAuto(n, t, i) {
    t != undefined && t.preventDefault();
    $("ul.listcompare").find("li").length > 0 && idcompare.length > 0 && (urlcompare = [],
        idcompare = [],
        $(".stickcompare").remove());
    var u = $(".cate a[data-pid='" + n + "']"), r;
    return (i == undefined ? r = u.attr("href") : (u = $(i),
        r = u.attr("data-src")),
        urlcompare.length > 0 && r.indexOf(urlcompare[0].slice(1, urlcompare[0].slice(1, -1).indexOf("/") + 1)) < 0) ? !1 : (idcompare[idcompare.length] = parseInt(n),
...
function closeTipCompare(n) {
    ...
    $(".cate li .tip-abs.show").length > 0 && ($(".cate li .tip-abs").next().show(),
        $(".cate li .tip-abs").remove())
}
function showTipCompare() {
    var n = $(".locationbox__popup:visible").length == 0
        , t = getCookie("DMX_CompareTip");
    t == null && typeof isShowTipCompare != "undefined" && isShowTipCompare.toString().toLowerCase() === "true" && $(window).scrollTop() > 150 && $("#lstp .cate > li").length <= 10 && n && ($(".cate li .tip-abs").append('<div class="overlaytip" onclick="closeTipCompare(event)"><\/div>'),
        setTimeout(function () {
    ...
    $.ajax({
        ...
        success: function (n) {
            if (n !== null && n !== "") {
                var u = $(n).find("li");
                $("#ss-now .stage").remove();
                u !== undefined && (u.each(function () {
                    addToCompare($(this).data("id"), null, this)
                }),
                    createCookie("ck_idcompare", idcompare.toString(), 30),
                    $(".stickcompare").addClass("spaceInDown").show())
            }
            i !== undefined && t > 0 ? addToCompare(t, event, "div.box02__right", r) : t > 0 && addToCompare(t)
        },
        error: function (n) {
            console.log(n)
        }
...
function countCompare() {
    var t = getCookie("ck_idcompare"), n;
    let i = !1;
    t !== "" && t !== null && (n = t.split(","),
        n.length > 0 ? (i = !0,
            $(".sticky-bar-ss").length > 0 ? isMobile ? $(".sticky-bar-ss span").text("(" + n.length + ")") : $(".sticky-bar-ss").append("<span class='sticky-bar-number'>" + n.length + "<\/span>") : ($(".stickcompare").length > 0 && $(".stickcompare").is(":hidden") == !1 ? $("#ss-now").hide() : $("#ss-now").show(),
                document.isDesktop == !1 && document.productId > 0 && $("#ss-now").hide(),
                $("#count-ss").text("(" + n.length + ")"))) : $(".sticky-bar-ss .sticky-bar-number").length > 0 && $(".sticky-bar-ss .sticky-bar-number").remove());
    i || ($(".sticky-bar-ss").length == 0 ? $("#ss-now").hide() : isMobile ? $(".sticky-bar-ss span").text("") : $(".sticky-bar-ss .sticky-bar-number").remove())
}
function cacheError(n) {
    ...
    t !== "" && ($(".stickcompare label.error").show().text(t).animate({
        ...
        $(".stickcompare").length > 0 && $(".stickcompare").is(":hidden") && $(".errorcompare").text(t).show(),
        setTimeout(function () {
            $(".stickcompare label.error").hide();
...
function OpenPopup(n) {
    ...
    if (flagOpenPopup = !0,
        ...
        return cacheError("full"),
            !1;
    if ($(n).append(appendLoadingViewMore()),
        e = document.cateID,
        t = localStorage.getItem("viewedHistory"),
        t != null && !JSON.stringify(t).includes("proId") && !JSON.stringify(t).includes("cateId"))
        return localStorage.removeItem("viewedHistory"),
            !1;
    if (t = JSON.parse(t),
        u = [],
    ...
    $.ajax({
        ...
        success: function (t) {
            ...
            flagOpenPopup = !1;
            $(".popup-addsp").show();
            t != null && t.errorCode == 1 ? ($(".popup-addsp .pro-compare_viewed").html(t.html),
                t.html == "" && t.html.trim() == "" ? $(".compare-popup h4").hide() : $(".compare-popup h4").show(),
                RemoveOnclickHtml($(".pro-compare li a.pro-nrview")),
                RemoveOnclickHtml($(".pro-compare li a:first-child")),
                CheckButtonCompareCategory()) : $(".compare-popup h4").hide()
        }
    })
}
function ClosePopup() {
...
function SearchProductCompare(n, t) {
    ...
    if (i == "" || i.length < 2 || r <= 0)
        return !1;
    if (xhrCompare && xhrCompare.abort(),
    ...
    xhrCompare = $.ajax({
        ...
        success: function (n) {
            ...
            n != null && n.errorCode == 1 && n.html != "" ? ($(".pro-compare_search").html(n.html),
                $(".pro-compare_search ul").show(),
                RemoveOnclickHtml($(".pro-compare li a.pro-nrview")),
                RemoveOnclickHtml($(".pro-compare li a:first-child")),
                CheckButtonCompareCategory()) : $(".pro-compare_search").html("<li class='text-center'>Không tìm thấy kết quả cho từ khóa: <b>" + n.keyword + "<\/b><\/li>");
            xhrCompare = !1
        }
    })
}
...
function RemoveAllIdCompare() {
    ...
    $(".box02").each(function () {
        $(this).find(".box02__right").removeClass("active").html("<i class='icondetail-sosanh'><\/i> So sánh")
    });
    ClosePopup();
    clearCompare();
    closeCompareBox();
...
function filterPros(n) {
    ...
    if (i) {
        let i = $(n.e)
            ...
            , r = n.isCallTotal
            , u = $("#paging").length > 0;
        if (n.isViewNow !== !0 && resetProductsObj(),
            t == undefined || t == "false" ? t = !1 : (t || t == "true") && (t = !0),
            t || pIdxActive > 0 ? (pIdxActive > 0 && document.pageIndex == 0 && !isIgnorePageIndex ? isIgnorePageIndex = !0 : n.pIndexGoto >= 0 ? document.pageIndex = n.pIndexGoto : document.pageIndex += 1,
                resetProductsObj()) : document.pageIndex = pIinFor > 0 ? pIinFor : 0,
            BuildLinkHash(!1, t),
            ...
            setTimeout(function () {
                ...
                $("#paging").length > 0 && (document.TotalCount > 0 ? ($("#paging").show(),
                    genPaging(document.TotalCount, document.pageSize, document.pageIndex)) : $("#paging").hide())
            }, 300);
            return
        }
        xhrFilter = $.ajax({
            ...
            beforeSend: function () {
                t && document.pageIndex > 0 && pIdxActive == 0 && !u ? ($(".view-more a").addClass("prevent"),
                    $(".view-more a").append(appendLoadingViewMoreNew())) : (isPageIndexLoading && $("#preloader").addClass("fixed"),
                        $("#preloader").show(),
                        $(".box-filter.top-box").addClass("disabled"),
                        $(".box-sort").addClass("disabled"))
            },
            success: function (u) {
                if ($(".box-filter").removeClass("disabled"),
                    ...
                    $("#paging").length > 0 && (n.pIndexGoto = n.pIndexGoto < 0 ? 0 : n.pIndexGoto,
                        $("#paging").show(),
                        pIdxActive = 0,
...
function totalFilterPros(n = false) {
    ...
    productFilterObj.total >= 0 ? (console.log(productFilterObj.textResponseApi),
        successXhrTotal(productFilterObj.total, n)) : ($(".block-manu .filter-show").addClass("hascount"),
            xhr = $.ajax({
...
function successXhrTotal(n, t = false, i = "") {
    ...
    t && (showHideViewMore(document.TotalCount),
        $(".sort-total b").html(n));
...
function successXhrFilter(n, t, i = false, r = false) {
    ...
    if ($("#empty").remove(),
        ...
        (document.pageIndex == 0 || varFilterObj.pIndexGoto >= 0) && (isPageIndexLoading || scrollByTag(".block-scroll-main.box-filter")),
        n !== undefined && n.parent().hasClass("f-smooth") && window.location.hash.length <= 0) {
        o = $(this).attr("href");
        window.location.href = o;
        return
    }
    if (r || (linkRedirectHashTotal = linkRedirectHash),
        ...
        manuParams.length == 1 ? (u = $(".filter-list.manu a.check").data("name"),
            u !== undefined && u !== "" && $(".box-sort .manu-sort").text(u)) : $(".box-sort .manu-sort").hide()
    } else
        !r || varFilterObj.pIndexGoto >= 0 ? (e = "",
            h = '<div id="empty"><i class="empty"><\/i>Không có sản phẩm nào phù hợp với tiêu chí tìm kiếm!{back-to-category}<\/div>',
            document.cateName !== undefined && document.cateName !== "" && (e = '<p><a href="javascript:;" onclick="reloadURL()">Xem tất cả ' + document.cateName.toLowerCase() + "<\/a><\/p>"),
            $(".listproduct").not(".owl-carousel").html(h.replace("{back-to-category}", e)),
            $(".box-sort").addClass("hide-ext"),
            endActivePageIndex()) : $(".view-more").hide();
    ...
    $(".colors a.check").length > 0 ? $(".colors a.check").each(function () {
    ...
    extParams.indexOf("fast") >= 0 && $(".listproduct").not(".owl-carousel").find("li").length > 0 && (f = "<div class='fast-deli'>" + $(".box-checkbox a[data-type='fast']")[0].outerHTML + "<\/div>",
        $(".listproduct li").find(".item-ss").length > 0 ? ($(f).insertBefore(".item-ss"),
            $(".listproduct li").find(".item-bottom").each(function () {
                $(this).parents(".item").find(".fast-deli").length <= 0 && $(this).parents(".item").find(".item-bottom").prepend(f)
            })) : $(".listproduct").not(".owl-carousel").find("li").append(f));
    extParams.indexOf("cbspk") >= 0 ? $(".extend a.fastdeli").hide() : $(".extend a.fastdeli").is(":visible") == !1 && $(".extend a.fastdeli").show()
}
function LoadCheckAjax() {
    ...
    if (varFilterObj.isMore || varFilterObj.isViewNow == !1)
        return isLoadAjax = !0,
            !0;
    if (t = document.isWatch == "True",
        manuParams != null && manuParams.length > 0)
        if (manuParams.length == 1)
            $(".manu a").each(function () {
                if (manuParams.indexOf($(this).data("id") + "") >= 0 && $(this).data("href") !== undefined && $(this).data("href") !== "")
                    return u = "-" + $(this).data("href"),
                        isLoadAjax = !1,
                        r++,
                        !1
            });
        else if (isLoadAjax = !0,
            !t)
            return !0;
    ...
    if (rangeParams.length > 0)
        if (rangeParams.length == 1)
            $(".price a").each(function () {
                if (rangeParams.indexOf($(this).data("id") + "") >= 0 && $(this).data("href") !== undefined && $(this).data("href") !== "")
                    return f = "?p=" + $(this).data("href"),
                        e = "&g=",
                        isLoadAjax = !1,
                        r++,
                        !1
        ...
        if (propsParams.length == 1)
            $(".props a").each(function () {
                if (propsParams.indexOf($(this).data("id") + "") >= 0 && $(this).data("href") !== undefined)
                    return i = $(this).data("smooth") == 1 ? "-" + $(this).data("href") : e + $(this).data("href"),
                        isLoadAjax = !1,
                        r++,
                        !1
            });
            ...
            !t)
            return !0;
    if (clsParams != null && clsParams.length > 0 || !t && GetParamLinkHashMinMax() !== "" && GetParamLinkHashMinMax().indexOf("&") >= 0)
        return !0;
    if (t || (isLoadAjax = r <= 2 ? !1 : !0),
        isLoadAjax == !1) {
        if (n = n !== "" ? n : i.includes("&") ? u + f + i : u + i + f,
            n != "")
            return reloadURL(n, t),
                !1;
        reloadURL("")
    }
    if (t) {
        if (n = linkRedirectHashTotal,
            n.charAt(0) == "?") {
...
function LoadCheckAjaxExtend(n) {
    ...
    let t = i.data("href")
        , r = !0;
    return (location.hash == "" && manuParams.length == 0 && rangeParams.length == 0 && propsParams == 0 && clsParams == 0 && (extParams.length == 1 && $(".extend a.active").length == 0 ? r = !1 : extParams.length == 0 && i.data("newv2") == "True" && (r = !1)),
        r == !1 && (t = t !== "" ? t : urlProp.includes("&") ? urlManu + urlPrice + urlProp : urlManu + urlProp + urlPrice,
            t != "")) ? (t.charAt(0) == "?" && (t = t.replace(t.charAt(0), "#")),
                reloadURL(t),
                !1) : r
}
function reloadURL(n, t = false) {
    if (n == undefined && (n = ""),
        loadingRedirect(),
        t == !0 && document.cateUrl.indexOf("dong-ho") >= 0 && (document.cateUrl = "dong-ho-deo-tay"),
        t) {
...
function countTotal() {
    ...
    let t = manuParams.length + propsParams.length + clsParams.length + rangeParams.length + n;
    t = t - i;
    t > 0 ? ($(".count-total").html(t).show().addClass("active"),
        $(".filter-button").fadeIn()) : $(".count-total").html(0).hide()
}
function unActiveFilter(n) {
    var t = $(n), u = !1, r, i = "", s, f, e, o, h;
    if (t.parents(".filter-show").not(".show-total").find(".filter-list a.check").length > 0 ? r = t.parents(".filter-show").not(".show-total").find(".filter-list a.check") : t.parents(".show-total").find(".filter-list a.check").length > 0 && (r = t.parents(".show-total").find(".filter-list a.check")),
        t.parents(".filter-show").not(".show-total").find(".prop-minmax").length > 0 ? t.parents(".filter-show").not(".show-total").find(".prop-minmax").each(function (n) {
            n > 0 && (i += ",");
        ...
        (t.parents(".filter-show").not(".show-total").find(".price-slider").length > 0 || t.parents(".show-total").find(".price-slider").length > 0) && (s = i.split(","),
            i += (s.length > 1 ? "," : "") + "price"),
        r != undefined && r.length || i != "") {
        if (f = "",
            t.parents(".filter-show").not(".show-total").find(".manu").length > 0 ? f = "manu" : t.parents(".filter-show").not(".show-total").find(".props").length > 0 ? f = "prop" : t.parents(".filter-show").not(".show-total").find(".price").length > 0 && (f = "price"),
            removeActiveChildFilter(f == "manu" ? !0 : !1),
            resetTextActiveFilter(f),
            r != undefined && r.length > 0 && r.each(function () {
                let n = this.dataset.id;
                manuParams.indexOf(n) >= 0 && (u = !0,
                    $(".manu a[data-id=" + n + "]").removeClass("check"),
                    manuParams.splice(manuParams.indexOf(n), 1),
                    autoAddorRemoveFilterActive($(".show-total .manu a[data-id=" + n + "]"), null));
                propsParams.indexOf(n) >= 0 && (u = !0,
                    $(".props a[data-id=" + n + "]").removeClass("check"),
                    propsParams.splice(propsParams.indexOf(n), 1),
                    autoAddorRemoveFilterActive($(".show-total .props a[data-id=" + n + "]"), null));
                clsParams.indexOf(n) >= 0 && (u = !0,
                    $(".colors a[data-id=" + n + "]").removeClass("check"),
                    clsParams.splice(clsParams.indexOf(n), 1),
                    autoAddorRemoveFilterActive($(".show-total .colors a[data-id=" + n + "]"), null));
                rangeParams.indexOf(n) >= 0 && (u = !0,
                    $(".price a[data-id=" + n + "]").removeClass("check"),
                    rangeParams.splice(rangeParams.indexOf(n), 1),
                    autoAddorRemoveFilterActive($(".show-total .price a[data-id=" + n + "]"), null))
            }),
            i !== "" && i !== undefined)
            if (u = !0,
                i.indexOf("price") >= 0 && $(".price-slider").find("input").each(function () {
                    $(".filter-list.price a").length > 0 ? ($(".price-slider .range-toggle span").removeClass("down"),
                        $(".price-slider .container").slideUp()) : textActiveFilter($(".price-slider"), "Giá", !0);
                    resetPriceRange();
                ...
                for (o = 0; o < e.length; o++)
                    $(".prop-minmax." + e[o]).find("input").each(function () {
                        getOrRemoveRangeParamByName($(this), !0)
                    });
            else
                $(".prop-minmax." + i).find("input").each(function () {
                    getOrRemoveRangeParamByName($(this), !0)
                });
        if (u) {
            ...
            manuParams.length + propsParams.length + clsParams.length + rangeParams.length + extParams.length == 0 && (h || (location.href = document.cateUrl));
            varFilterObj.isCallTotal = !0;
...
function showHideViewMore(n) {
    if (n > 0) {
        ...
        t > 0 ? ($(".view-more").removeClass("hide").show(),
            $(".view-more .remain").html(t)) : $(".view-more").hide()
    } else
        $(".view-more").hide()
}
function GetValueFromHashKey(n) {
    var i, r, u, t;
    if (((n === undefined || n == "") && (n = location.hash.replace("#", "")),
        n === undefined || n == "") || (i = n.split("&"),
            i.length == 0))
        return null;
    for (r in i)
        (u = i[r],
            t = u.split("="),
            t.length == 2) && (t[0] == "m" ? manuParams = t[1].split(",") : t[0] == "r" ? rangeParams = t[1].split(",") : t[0] == "p" ? propsParams = t[1].split(",") : t[0] == "cls" ? clsParams = t[1].split(",") : t[0] == "ext" ? (extParams = t[1].split(","),
                extParams.indexOf("fast") >= 0 && getLocationCustomer().wardID > 0 == !1 && extParams.splice(extParams.indexOf("fast"), 1)) : t[0] == "o" ? ordersParams = parseInt(t[1]) : t[0] == "add" ? additionFilterParam = parseInt(t[1]) : t[0] == "pi" ? document.pageIndex = parseInt(t[1]) : t[0] == "ps" ? document.pageSize = parseInt(t[1]) : t[0] == "cids" ? cidsParams = t[1].split(",") : t[0] == "cls" ? clsParams = t[1].split(",") : t[0] == "mGenius" ? manuPKGenius = t[1] : t[0] == "priceminmax" ? priceRangeParams = t[1] : t[0] == "capacityminmax" ? RangeObj.CapacityRangeParams = t[1] : t[0] == "widthminmax" ? RangeObj.WidthRangeParams = t[1] : t[0] == "heightminmax" ? RangeObj.HeightRangeParams = t[1] : t[0] == "deepminmax" && (RangeObj.DeepRangeParams = t[1]))
}
function MapHashToFilter() {
    var n;
    location.hash != "" && ($(".extend a.active").removeClass("active"),
    ...
    manuParams != null && manuParams.length > 0 && $(".manu a").each(function () {
        manuParams.indexOf($(this).data("id") + "") >= 0 ? ($(this).addClass("check"),
            autoAddorRemoveFilterActive(null, this),
            textActiveFilter($(this), "Hãng")) : $(this).removeClass("check")
    });
    clsParams != null && clsParams.length > 0 && $(".colors a").each(function () {
        clsParams.indexOf($(this).data("id") + "") >= 0 ? ($(this).addClass("check"),
            autoAddorRemoveFilterActive(null, this),
            textActiveFilter($(this), "Màu")) : $(this).removeClass("check")
    });
    rangeParams != null && rangeParams.length > 0 && ($(".price a").each(function () {
        rangeParams.indexOf($(this).data("id") + "") >= 0 ? ($(this).addClass("check"),
            autoAddorRemoveFilterActive(null, this),
            textActiveFilter($(this), "Giá")) : $(this).removeClass("check")
    }),
    ...
    ordersParams > 0 && ($(".sort a").removeClass("check"),
    ...
    priceRangeParams !== "" && (n = priceRangeParams.split("-"),
        n.length == 2 && (rangePriceSlider.noUiSlider.set([n[0], n[1]]),
            rangePriceSliderTotal.noUiSlider.set([n[0], n[1]]),
            updateValAndAttrValue($("input[name='price-min-value']"), ToNumberFormat(n[0])),
            updateValAndAttrValue($("input[name='price-max-value']"), ToNumberFormat(n[1])),
            $(".price-slider .container").slideDown(),
            $(".price-slider .range-toggle a span").addClass("down")));
    RangeObj.CapacityRangeParams !== "" && (n = RangeObj.CapacityRangeParams.split("-"),
        autoFillMinMaxFromHash("capacity", n));
    RangeObj.WidthRangeParams !== "" && (n = RangeObj.WidthRangeParams.split("-"),
        autoFillMinMaxFromHash("width", n));
    RangeObj.HeightRangeParams !== "" && (n = RangeObj.HeightRangeParams.split("-"),
        autoFillMinMaxFromHash("height", n));
    RangeObj.DeepRangeParams !== "" && (n = RangeObj.DeepRangeParams.split("-"),
        autoFillMinMaxFromHash("deep", n));
    manuPKGenius != null && manuPKGenius.length > 0 && $(".group-manu a").each(function () {
        manuPKGenius.indexOf($(this).data("checkurl") + "") >= 0 ? $(this).addClass("active") : $(this).removeClass("active")
    });
    $(".group-manu a.active").length > 0 && (isClickFilterManuGenius = !0)
}
function autoFillMinMaxFromHash(n, t) {
    t !== undefined && t.length == 2 && (updateValAndAttrValue($("input[name=" + n + "-min-value]"), ToNumberFormat(t[0])),
        updateValAndAttrValue($("input[name=" + n + "-max-value]"), ToNumberFormat(t[1])),
        $(".prop-minmax." + n).parents(".props").length > 0 && ($(".prop-minmax." + n).parents(".props").find(".container").slideDown(),
            $(".prop-minmax." + n).parents(".props").find(".range-toggle span").addClass("down")))
}
function BuildLinkHash(n = false, t = false) {
    var h = manuParams.length > 0 ? "m=" + manuParams.toString() + "&" : "", c = propsParams.length > 0 ? "p=" + propsParams.toString() + "&" : "", l = clsParams.length > 0 ? "cls=" + clsParams.toString() + "&" : "", a = rangeParams.length > 0 ? "r=" + rangeParams.toString() + "&" : "", u = ordersParams != -1 ? "o=" + ordersParams + "&" : "", f = extParams.length > 0 ? "ext=" + extParams + "&" : "", e = additionFilterParam > 0 ? "add=" + additionFilterParam + "&" : "", o = document.cateID !== undefined ? "c=" + document.cateID + "&" : 0, s = "", i, r;
    if (typeof searchQuery != "undefined" && searchQuery !== undefined && searchQuery.KeyWord !== "" && searchQuery.KeyWord !== undefined && (s = "kw=" + searchQuery.KeyWord + "&"),
        i = "",
        r = "pi=" + (document.pageIndex !== undefined ? document.pageIndex : 0),
        n)
        i = "ps=1&",
            linkRedirectHashTotal = o + h + c + l + a + f + u + e + i + GetParamLinkHashMinMax() + "pi=0",
            linkRedirectHashTotal = linkRedirectHashTotal.trim() !== "" ? "?" + linkRedirectHashTotal : "";
    else {
        let n = $("#paging").length > 0;
        t && !n && location.hash.trim() !== "" ? (linkRedirectHash = linkRedirectHash.replace("pi=" + (document.pageIndex - 1), ""),
            linkRedirectHash = linkRedirectHash + r) : linkRedirectHash = t && !n && linkRedirectHash !== linkRedirectHashTotal ? o + s + f + u + e + r : o + s + h + c + l + a + f + u + e + i + GetParamLinkHashMinMax() + r;
...
function reLoadChildFilter() {
    if (manuParams.length == 1) {
        if ($(".child-filter .props").length > 0 && $(".child-filter .props a").first().data("manuid") == manuParams[0])
            return !1;
            ...
            success: function (n) {
                n != "" && ($(".child-filter .props").html(n),
                    ...
                    $(".child-filter-outer .props a").each(function () {
                        propsParams.indexOf($(this).data("id").toString()) >= 0 && $(".props a[data-id=" + $(this).data("id") + "]").addClass("check")
                    }))
            },
            error: function (n) {
                console.log(n)
        ...
        $(".child-filter").addClass("hide"),
            $(".child-filter-outer .single-prop").length <= 0 && $(".child-filter-outer").addClass("hide")
}
...
function textActiveFilter(n, t, i = false) {
    var u = $(n), r, f, e, s, o;
    if (u.parents(".filter-item").length > 0)
        r = u.parents(".filter-item");
    ...
    r.find(".c-btnbox.check").length > 0 && !i ? (e = "",
        r.find(".jsTitle").length > 0 && r.find(".jsTitle").addClass("active"),
        e = r.find(".c-btnbox.check").find("img").length > 0 ? u.hasClass("check") ? u.find("img").attr("alt") : r.find(".c-btnbox.check img").last().attr("alt") : u.find(".prop-hrd").length > 0 ? u.hasClass("check") ? u.find(".prop-hrd").text() : r.find(".c-btnbox.check").last().find(".prop-hrd").text() : u.hasClass("check") ? u.text() : r.find(".c-btnbox.check").last().text(),
        f == ".props" ? (s = u.data("id"),
            e == undefined && (e = u.text()),
            $("a[data-id=" + s + "]").parents(".filter-item").find(".jsTitle span").text(e + (r.find(".c-btnbox.check").length > 1 ? ",..." : ""))) : $(f).parents(".filter-item").find(".jsTitle span").text(e + (r.find(".c-btnbox.check").length > 1 ? ",..." : ""))) : f == ".props" ? (s = u.data("id"),
                o = $("a[data-id=" + s + "]").parents(".filter-item").find(".jsTitle").data("textorg"),
                o !== undefined && (t = o),
                $("a[data-id=" + s + "]").parents(".filter-item").find(".jsTitle span").text(t)) : (o = r.find(".jsTitle").data("textorg"),
                    o !== undefined && (t = o),
...
function getTextActiveSliderRange() {
    ...
    $(".text-active").each(function () {
        var n, t;
        $(this).attr("data-activetxt") !== undefined && ($(this).attr("data-activetxt") !== "" ? $(this).parents(".filter-item").length > 0 && $(this).parents(".filter-item").find(".jsTitle").length > 0 && ($(this).parents(".filter-item").find(".jsTitle span").text($(this).attr("data-activetxt")),
            $(this).parents(".filter-item").find(".jsTitle").addClass("active")) : (n = !1,
                $(this).parents(".filter-item").find(".text-active").each(function () {
                    $(this).attr("data-activetxt") !== "" && (n = !0)
                }),
                $(this).parents(".filter-item").find(".props a.check").length > 0 && (n = !0),
                n || (t = $(this).parents(".filter-item").find(".jsTitle").data("textorg"),
...
function activeOrUnActiveBlock() {
    ...
    $("div").find("[data-activetxt]").each(function () {
        $(this).attr("data-activetxt") !== "" && $(this).parents(".filter-item").find(".jsTitle").addClass("active")
    })
}
function activeNewFilterV2(n) {
    if (n > 0 && $("a[data-newv2='True']").length > 0) {
        ...
        if (t.length > 0)
            return $("a[data-newv2='True']").addClass("active"),
                !0
    }
    return !1
}
...
function afterDoneActivePageIndex() {
    var t = pIdxActive * parseInt(document.pageSize), n, i;
    pIdxActive > 0 && isPageIndexLoading == !0 && $(".listproduct > li").eq(t).length > 0 && (isPageIndexLoading = !1,
...
function remove_unicode(n) {
    return n === undefined ? "" : (n = n.toLowerCase(),
...
function loadMoreProductOther(n) {
    var i = $(n), t = i.prev("ul"), r;
    t.length > 0 && (r = 10,
        $(t).find("li.hide").each(function (n, t) {
...
function showTabIndexOther(n) {
    function f() {
        ...
        n > i && ($("ul.listproduct[id=" + t + "]").find("li").each(function (n) {
            ...
            r.removeClass("hide").show().find(".remain").text(n - i));
        $("#preloader").hide();
    ...
    var r = $(n)
        ...
        , t = r.data("bannerid")
        , i = 15;
    u > 0 && ($("ul.listproduct[id=" + t + "]").find("li").length > 0 ? ($("ul.listproduct").hide(),
        f()) : $.ajax({
            ...
            success: function (n) {
                if ($("#empty").remove(),
                    ...
                    n == "" || n.trim() == "")
                    $("ul.listproduct[id=" + t + "]").append('<div id="empty"><i class="empty"><\/i>Không có sản phẩm nào phù hợp với tiêu chí tìm kiếm!<\/div>');
                f()
            },
            error: function (n) {
                console.log(n)
...
function loadMoreProductAccessories(n) {
    var t = $(n), i, r;
    t.find(".bubblingG").length > 0 || (i = parseInt(t.data("pagesize")),
        r = 0,
        ...
        $.ajax({
            ...
            success: function (n) {
                ...
                r <= 0 ? t.hide() : ($(".bubblingG").remove(),
                    t.find(".remain").text(r));
    ...
    $(document).on("click", ".watch-type .tabs-type span", function (n) {
        ...
        if (n.preventDefault(),
            ...
            var s = $(this).data("prop")
                , h = $(this).text()
                , l = $(this).data("url");
            t !== undefined && t != "" && ($(this).parent().find("span").removeClass("current").removeClass("active-tab"),
                $(this).addClass("current").addClass("active-tab"),
                u = $(this).parent().parent().parent().find(".prt-watch .listproduct"),
                u.length == 1 && (r = $(this).parent().parent().find("a.see-all"),
                    i = {
                    ...
                    $.ajax({
                        ...
                        success: function (n) {
                            ...
                            n != "" ? (u.html(n),
                                ...
                                r !== undefined && r.length > 0 && (c = "/dong-ho-deo-tay",
                                    f ? (c = "/dong-ho-thong-minh#p=" + s,
                                        r.attr("href", c)) : e == !1 ? (c = c + "#p=" + i.StrPropID,
                                            o && i.ManuId != "" && (c = c + "&m=" + i.ManuId,
                                                l != undefined && l != "" && (c = l)),
                                            t != null && t === 147889 && (c = $(".propDVTE").attr("data-link")),
                                            r.attr("href", c)) : (c = c + `#c=7264&m=${i.ManuId}&r=781,782,783,784&o=8&pi=0`,
                                                r.attr("href", c)),
                                    a = r.data("text"),
                                    f ? a = a.replace("thời trang", "thông minh") : (e == !1 && (h = h.toLowerCase()),
                                        h.toLowerCase() != "đồng hồ thời trang" && (a = a + " " + h)),
                                    r.text(a),
                                    r.show())) : (u.owlCarousel("destroy"),
                                        u.find("li").remove(),
                                        r.hide())
                        },
                        error: function (n) {
...
function replaceTextSeeAllWatchPage() {
    if ($(".watch-type .tabs-type span.current").length > 0) {
        ...
        $(".watch-type .tabs-type span.current").each(function () {
            ...
            t = $(this).text();
            i = $(this).data("id");
            $(this).hasClass("watch-smart-watch") ? (n = "/dong-ho-thong-minh#p=" + i,
                u.attr("href", n),
                t = t.toLowerCase()) : $(this).hasClass("luxury-watch") ? (n = n + `#c=7264&m=${i}&r=781,782,783,784&o=8&pi=0`,
                    u.attr("href", n)) : $(this).hasClass("monopoly-watch") ? (n = n + "#m=" + i + "&p=182616",
                        $(this).data("url") != undefined && $(this).data("url") != "" && (n = $(this).data("url")),
                        u.attr("href", n)) : (n = n + "#p=" + i,
                            u.attr("href", n),
                            t = t.toLowerCase());
...
function filterProsPKGenuine(n = false) {
    ...
    var i = cidsParams.length > 0 ? "cids=" + cidsParams.toString() + "&" : ""
        ...
        , t = manuPKGenius
        , s = manuPKGenius !== "" ? "mGenius=" + manuPKGenius.replace("-", " ") + "&" : "";
    ...
    xhrPKGenuine = $.ajax({
        ...
        cache: !0,
        beforeSend: function () {
            n ? ($(".view-more a").addClass("prevent"),
                $(".view-more a").append(appendLoadingViewMoreNew())) : ($("#preloader").addClass("fixed"),
                    $("#preloader").show())
        },
        success: function (n) {
            var s, c, l;
            if (console.log(n.textResponseApi),
                $(".box-sort").removeClass("hide-ext"),
                $(".box-sort .manu-sort").show(),
                document.TotalCount = n.total,
                $(".group-manu a.active").length > 0 && $(".group-manu a.active").data("name") !== undefined && $(".group-manu a.active").data("name") !== "" ? ($(".breadcrumb .sort-total").text("Phụ kiện " + $(".group-manu a.active").data("name")),
                    $(".box-sort.genuine .sort-total").text(n.total + " Phụ kiện " + $(".group-manu a.active").data("name"))) : $(".sort-total b").html(n.total),
                ...
                s = "",
                    c = '<div id="empty"><i class="empty"><\/i>Không có sản phẩm nào phù hợp với tiêu chí tìm kiếm!{back-to-category}<\/div>',
                    document.cateName !== undefined && document.cateName !== "" && (s = '<p><a href="javascript:;" onclick="reloadURL()">Xem tất cả ' + document.cateName.toLowerCase() + "<\/a><\/p>"),
                    $(".listproduct").html(c.replace("{back-to-category}", s)),
                    $(".box-sort").addClass("hide-ext"),
                    $(".view-more").hide();
            isClickFilterManuGenius && $(".box-quicklink.accessories").html(n.listcategory);
            ...
            t !== undefined && t !== "" && (linkHashPKGenuine = o + i + "mGenius=" + t.replace(" ", "-") + "&" + u + f + e + r);
...
function initSuggestAccess() {
    if (!($("#access-keyword").length <= 0)) {
        ...
        AutoComplete({
            ...
            _QueryArg: function () {
                return "catId=" + document.cateID + "&cateBaseUrl=" + document.cateUrl + "&term"
            },
            _Pre: function () {
                return this.Input.value == "" && $(".autocomplete").hide(),
                    this.Input.value
            },
            _Blur: function (n) {
                $(n.relatedTarget).parents(".autocomplete") || $(".suggest-accessory .autocomplete").length > 0 && $(".suggest-accessory .autocomplete").hide()
            },
            _Focus: function () {
                $(".suggest-accessory .autocomplete ul li").length > 0 && $(".suggest-accessory .autocomplete").show()
            },
            _Position: function () {
            ...
            _Post: function (n) {
                return $(n).find("li").length > 0 && $(".autocomplete").show(),
                    n
            },
            _Select: function (n) {
...
function EventPriceRange() {
    function t(t = false) {
        ...
        i > r || i < minval ? (updateValAndAttrValue($("input[name='price-min-value']"), ToNumberFormat(minval)),
            i = minval) : updateValAndAttrValue($("input[name='price-min-value']"), ToNumberFormat(i));
    ...
    function i(t = false) {
        ...
        r > i || i > maxval ? (updateValAndAttrValue($("input[name='price-max-value']"), ToNumberFormat(maxval)),
            i = maxval) : updateValAndAttrValue($("input[name='price-max-value']"), ToNumberFormat(i));
...
function EventPropRange() {
    function t(n) {
        var t = $(n)
            ...
            , f = t.hasClass("max")
            , r = !1;
        return u && parseInt(i) < parseInt(t.data("minvalue")) || parseInt(i) > parseInt(t.parents(".prop-minmax").find("input.max").val()) ? r = !0 : (f && parseInt(i) > parseInt(t.data("maxvalue")) || parseInt(i) < parseInt(t.parents(".prop-minmax").find("input.min").val())) && (r = !0),
            r
    }
    function n(n) {
        var r = $(n).val()
...
function resetPriceRange() {
    ...
    rangePriceSlider !== null && (rangePriceSlider.noUiSlider.set([minval, maxval]),
        rangePriceSliderTotal.noUiSlider.set([minval, maxval]),
        updateValAndAttrValue($("input[name='price-min-value']"), ToNumberFormat(minval)),
        updateValAndAttrValue($("input[name='price-max-value']"), ToNumberFormat(maxval)),
...
function loadPriceRangeSlider(n) {
    ...
    resetPriceRange();
    $(".price-slider .container").is(":visible") == !1 ? ($(".price-slider .container").slideDown(),
        $(".price a.check").length > 0 && ($(".price a.check").each(function () {
            var n = this.dataset.id;
            rangeParams.indexOf(n) >= 0 && (rangeParams.splice(rangeParams.indexOf(n), 1),
                autoAddorRemoveFilterActive(this, null),
                $(".price a[data-id=" + n + "]").removeClass("check"))
        }),
            totalFilterPros())) : ($(".price-slider .container").slideUp(),
                callFilterRangeSlider(!0))
}
function loadRangeInput(n) {
    ...
    $(".prop-minmax." + t).find("span.down").length > 0 ? ($(".prop-minmax." + t).find(".container").slideDown(),
        $(".prop-minmax." + t).parents(".props").find("a.check").length > 0 && ($(".prop-minmax." + t).parents(".props").find("a.check").each(function () {
            var n = this.dataset.id;
...
function updateTextActiveRangeMinMax() {
    ...
    function t(n) {
        var r = $("input[name=" + n + "-min-value").val() !== "0" ? $("input[name=" + n + "-min-value").val() : "0", u = $("input[name=" + n + "-max-value").val() !== "0" ? $("input[name=" + n + "-max-value").val() : "0", t = $(".text-active." + n).attr("data-unit"), i, f;
        r == "0" && u == "0" || r == "" && u == "" ? $(".text-active." + n).attr("data-activetxt", "") : t !== undefined && t !== "" && ($(".filter-item .text-active." + n).find(".prop-minmax-input").addClass("has-value"),
            t = " " + t,
            i = "Từ ",
            f = !1,
            $(".text-active." + n).parent().find(".prop-minmax").length > 1 && $(".filter-item .prop-minmax-input.has-value").length > 1 && (f = !0),
            n == "width" ? i = "Ngang " : n == "height" ? i = "Cao " : n == "deep" && (i = "Sâu "),
            $(".text-active." + n).attr("data-activetxt", i + r + t + " - " + u + t + (f ? ",..." : "")));
...
function getOrRemoveRangeParamByName(n, t = false) {
    function r(n, t, i = false) {
        ...
        i ? (n.parents(".prop-minmax-input").removeClass("has-value"),
            r = "",
            u = "") : n.parents(".prop-minmax-input").addClass("has-value");
...
function LoadNewProductMergingByID() {
    $(document).on("click", ".prods-group ul li", function (n) {
        var t = $(this);
        if ((n.preventDefault(),
            !$(this).hasClass("act")) && t.data("id") !== "" && parseInt(t.data("id")) > 0) {
...
function autoAddorRemoveFilterActive(n, t) {
    ...
    if (!($(".list-filter-active").length <= 0)) {
        ...
        if (t !== undefined && t !== null && $(t).length > 0 && (f = !0,
            ...
            switch (r) {
                case 1:
                    if ($(".list-filter-active .manu a[data-id=" + $(t).data("id") + "]").length > 0)
                        break;
                    ...
                    break;
                case 2:
                    if ($(".list-filter-active .price a[data-id=" + $(t).data("id") + "]").length > 0)
                        break;
                    i = i.replace("{id}", $(t).data("id"));
                    ...
                    break;
                case 3:
                    if ($(".list-filter-active .props a[data-id=" + $(t).data("id") + "]").length > 0)
                        break;
                    i = i.replace("{id}", $(t).data("id"));
                    i = i.replace("{text}", $(t).text());
                    ...
                    break;
                case 4:
                    if ($(".list-filter-active .colors a[data-id=" + $(t).data("id") + "]").length > 0)
                        break;
                    i = i.replace("{id}", $(t).data("id"));
                    i = i.replace("{text}", $(t).text());
            ...
            $(".price-slider").length > 0 && $(".price-slider").first()[0].dataset.activetxt !== "" && ($(".price-slider-active").remove(),
                u = '<a href="javascript:;" class="price-slider-active" onclick="resetPriceRangeOnLstFilterActive()"><span>{text}<\/span><i class="iconcate-closess"><\/i><\/a>',
                u = u.replace("{text}", $(".price-slider").first()[0].dataset.activetxt),
                $(".list-filter-active .price").append(u)),
                $(".prop-minmax-input.has-value").length > 0 && $(".prop-minmax-input.has-value").each(function () {
                    ...
                    if ($(n).length > 0 && parseInt($(n).attr("data-type")) !== "") {
                        var t = '<a href="javascript:;" class="prop-slider-active" data-type="{type}"><span>{text}<\/span><i class="iconcate-closess"><\/i><\/a>'
                            , i = $(n).attr("data-type");
                        if ($(".prop-slider-active[data-type=" + i + "]").length > 0 && $(".prop-slider-active[data-type=" + i + "]").remove(),
                            $(n).attr("data-activetxt") == undefined || $(n).attr("data-activetxt") == "")
                            return !1;
...
function removeFilterActive(n) {
    ...
    switch (t) {
        ...
        case 3:
            ...
            break;
        case 4:
            $(".show-total-item .colors a[data-id=" + $(n).data("id") + "]").hasClass("check") && $(".show-total-item .colors a[data-id=" + $(n).data("id") + "]").trigger("click")
    }
}
        ...
        if (!n && $(".banner__promote").length > 0 && $(this).scrollTop() > 1e3)
            if (n = !0,
                ...
                $.ajax({
                    ...
                    beforeSend: function () { },
                    success: function (n) {
                        (n != "" || n.trim() != "") && $(".banner__promote").each(function (t, i) {
                            var r = $(i).find("ul"), u;
                            r.html(n[t]);
...
function AddListProductImpressions() {
    var f = $(".listproduct .item a.main-contain"), r = 0, t = {}, e = [], u, i, n;
    if (f.length > 0)
        for (u = 0; u < f.length; u++)
            r++,
                ...
                n = i.parentNode.parentNode.parentNode.parentNode.parentNode.dataset.block,
                n !== undefined && n != null && n != "" ? t.list = n : (n = i.parentNode.parentNode.dataset.block,
                    n !== undefined && n != null && n != "" ? t.list = n : (n = $(".ht-sale__tab li.active").text(),
                        n !== undefined && n != null && n != "" && (t.list = n))),
                t.position = r,
                e.push(t),
                t = {},
                (u + 1 == f.length && r < 5 || r == 5) && (gtm_ListProductImpressions(e),
                    r = 0,
                    e = [])
}
    ...
    if (n !== undefined && n != null && n.length > 0) {
        ...
        for (u = 0; u < n.length; u++)
            r++,
                ...
                t.category = i.dataset.cate,
                t.list = "List product in cate page",
                f = i.parentNode.parentNode.parentNode.parentNode.parentNode.dataset.block,
                f !== undefined && f != null && f != "" && (t.list = f),
                t.position = r,
                e.push(t),
                t = {},
                (u + 1 == n.length && r < 5 || r == 5) && (gtm_ListProductImpressions(e),
                    r = 0,
                    e = [])
    }
}
function removeActiveChildFilter(n = false) {
    n !== undefined && n == !0 && $(".props.props-child a.check").length > 0 && ($(".props.props-child a.check").each(function () {
        var n = this.dataset.id;
        propsParams.indexOf(n) >= 0 && (propsParams.splice(propsParams.indexOf(n), 1),
            $(".props a[data-id=" + n + "]").removeClass("check"))
    }),
...
function checkFilterApple() {
    var n = 0;
    return manuParams !== undefined && manuParams.length > 0 && $(".filter-list.manu .filter-manu.check").each(function () {
        return manu_name = $(this).attr("data-name").toUpperCase(),
            manu_name !== undefined && (manu_name.includes("APPLE") || manu_name.includes("MACBOOK") || manu_name.includes("IPAD") || manu_name.includes("IPHONE")) ? n = 1 : void 0
    }),
        n
}
function showVideoWater(n) {
    document.getElementById("youtube").src = "https://www.youtube.com/embed/" + n + "?showinfo=0&autoplay=1&mute=1";
...
function viewShortContentSEO() {
    ...
    $(".article__content a:first").find("img").length > 0 && $(".article .article__content").addClass("shortnew");
...
function createQuickMenu() {
    var t = $(".article__content").find("h3").not(".info h3"), f = $(".article__content").find("h4"), e = t.length - 1 + f.length, u;
    if (t.length && e > 1) {
        var i = '<div class="anchor-hd" id="QuickViewId"><p class="txt">Nội dung chính<\/p><div class="click-anchor crt" id="click-anchor"><\/div><div class="anchor-hd-list">'
            , r = 0
            , n = 0;
        t.each(function (u) {
            var f, e, o, h, s;
            ...
            e = $(this).clone();
            e.find(".dropcap") != null && e.find(".dropcap").length && (e.find(".dropcap").remove(),
                f = e.text().trim().replace(/^\d+/gm, "").trim(),
                f = delFstIndexTitle(f, ".").trim());
            i += "<h3 class='" + (n > 10 ? "hideItemReadmore" : "") + "'><a href='#hmenuid" + n + "' data-id='hmenuid" + n + "' onclick='autoCloseMenu(this, event)'>" + (u + 1) + ". " + f + "<\/a><\/h3>";
            o = $(this).nextUntil("h3");
            o != null && o.length > 0 && (h = !1,
                s = ' <ul class="subtitle">',
                o.each(function () {
                    if ($(this).is("h4")) {
                        h = !0;
                        ...
                        n += 1;
                        $(this).attr("id", "hmenuid" + r);
                        var t = $(this).text().trim().replace(/^\d+.?\d*/gm, "").trim();
                        t = delFstIndexTitle(t, ".").trim();
                        s += "<li class='" + (n > 10 ? "hideItemReadmore" : "") + "'><a href='#hmenuid" + n + "' data-id='hmenuid" + n + "' onclick='autoCloseMenu(this, event)'>" + t + "<\/a><\/li>"
                    }
                }),
                s += "<\/ul>",
                h && (i += s))
        });
        $(".article__content h2").length ? (u = $(".article__content h2").length,
...
function BuildActiveFilter(n = false) {
    ...
    if (n)
        $(".sort.accessories a").parent().removeClass("hide");
    else {
        if (ordersParams != 9)
            return;
        t.removeClass("check");
...
var flagOpenPopup, xhrCompare, xhrFilter, xhr, previousRequest, createCookie, xhrDelivery, xhrPKGenuine, linkHashPKGenuine, rangePriceSlider, rangePriceSliderTotal, manu_name;
!function (n, t) {
    ...
    return n = function (u) {
        ...
        if (n.isNumeral(u))
            f = u.value();
        else if (0 === u || "undefined" == typeof u)
            f = 0;
        else if (null === u || i.isNaN(u))
            f = null;
            ...
            if (t.zeroFormat && u === t.zeroFormat)
                ...
                for (o in r)
                    if (h = "function" == typeof r[o].regexps.unformat ? r[o].regexps.unformat() : r[o].regexps.unformat,
                        h && u.match(h)) {
                        s = r[o].unformat;
                        break
                    }
        ...
        n._ = i = {
            numberToFormat: function (t, i, r) {
                var o, a, u, h, p, nt, c, s = f[n.options.currentLocale], y = !1, tt = !1, w = 0, e = "", b = 1e12, k = 1e9, d = 1e6, it = 1e3, l = "", v = !1, g;
                if (t = t || 0,
                    a = Math.abs(t),
                    n._.includes(i, "(") ? (y = !0,
                        i = i.replace(/[\(|\)]/g, "")) : (n._.includes(i, "+") || n._.includes(i, "-")) && (p = n._.includes(i, "+") ? i.indexOf("+") : 0 > t ? i.indexOf("-") : -1,
                            i = i.replace(/[\+|\-]/g, "")),
                    n._.includes(i, "a") && (o = i.match(/a(k|m|b|t)?/),
                        o = o ? o[1] : !1,
                        n._.includes(i, " a") && (e = " "),
                        i = i.replace(new RegExp(e + "a[kmbt]?"), ""),
                        a >= b && !o || "t" === o ? (e += s.abbreviations.trillion,
                            t /= b) : b > a && a >= k && !o || "b" === o ? (e += s.abbreviations.billion,
                                t /= k) : k > a && a >= d && !o || "m" === o ? (e += s.abbreviations.million,
                                    t /= d) : (d > a && a >= it && !o || "k" === o) && (e += s.abbreviations.thousand,
                                        t /= it)),
                    n._.includes(i, "[.]") && (tt = !0,
                        i = i.replace("[.]", ".")),
                    ...
                    h ? (n._.includes(h, "[") ? (h = h.replace("]", ""),
                        h = h.split("["),
                        l = n._.toFixed(t, h[0].length + h[1].length, r, h[1].length)) : l = n._.toFixed(t, h.length, r),
                        u = l.split(".")[0],
                        l = n._.includes(l, ".") ? s.delimiters.decimal + l.split(".")[1] : "",
                        tt && 0 === Number(l.slice(1)) && (l = "")) : u = n._.toFixed(t, 0, r),
                ...
                if (n._.includes(u, "-") && (u = u.slice(1),
                    v = !0),
                    u.length < w)
                    for (g = w - u.length; g > 0; g--)
                        u = "0" + u;
                return nt > -1 && (u = u.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + s.delimiters.thousands)),
                    0 === i.indexOf(".") && (u = ""),
                    c = u + l + (e ? e : ""),
                    y ? c = (y && v ? "(" : "") + c + (y && v ? ")" : "") : p >= 0 ? c = 0 === p ? (v ? "-" : "+") + c : c + (v ? "-" : "+") : v && (c = "-" + c),
                    c
            },
            stringToNumber: function (n) {
                var u, i, e, r = f[t.currentLocale], s = n, o = {
                    thousand: 3,
                    million: 6,
                    billion: 9,
                    trillion: 12
                ...
                if (t.zeroFormat && n === t.zeroFormat)
                    ...
                    for (u in o)
                        if (e = new RegExp("[^a-zA-Z]" + r.abbreviations[u] + "(?:\\)|(\\" + r.currency.symbol + ")?(?:\\))?)?$"),
                            s.match(e)) {
                            i *= Math.pow(10, o[u]);
                            break
                        }
            ...
            reduce: function (n, t) {
                ...
                var u, r = Object(n), f = r.length >>> 0, i = 0;
            ...
            toFixed: function (n, t, i, r) {
                var u, e, o, f, s = n.toString().split("."), h = t - (r || 0);
                return u = 2 === s.length ? Math.min(Math.max(s[1].length, h), t) : h,
                    o = Math.pow(10, u),
                    f = (i(n + "e+" + u) / o).toFixed(u),
                    r > t - u && (e = new RegExp("\\.?0{1," + (r - (t - u)) + "}$"),
                        f = f.replace(e, "")),
                    f
            }
        },
        ...
        n.validate = function (t, i) {
            ...
            return c = f.currency.symbol,
                ...
                null !== u && (t = t.substr(1),
                    u[0] !== c) ? !1 : (u = t.match(/[^\d]+$/),
                        null !== u && (t = t.slice(0, -1),
                            u[0] !== e.thousand && u[0] !== e.million && u[0] !== e.billion && u[0] !== e.trillion) ? !1 : (o = new RegExp(h + "{2}"),
                                t.match(/[^\d.,]/g) ? !1 : (r = t.split(s),
                                    r.length > 2 ? !1 : r.length < 2 ? !!r[0].match(/^\d+.*\d$/) && !r[0].match(o) : 1 === r[0].length ? !!r[0].match(/^\d+$/) && !r[0].match(o) && !!r[1].match(/^\d+$/) : !!r[0].match(/^\d+.*\d$/) && !r[0].match(o) && !!r[1].match(/^\d+$/))))
        }
        ,
        n.fn = e.prototype = {
            clone: function () {
            ...
            format: function (i, u) {
                var o, f, e, s = this._value, h = i || t.defaultFormat;
                if (u = u || Math.round,
                    0 === s && null !== t.zeroFormat)
                    f = t.zeroFormat;
                else if (null === s && null !== t.nullFormat)
                    f = t.nullFormat;
                else {
                    for (o in r)
        ...
        function () {
            ...
            n.register("format", "bytes", {
                ...
                format: function (r, u, f) {
                    var h, e, o, c, s = n._.includes(u, "ib") ? i : t, l = n._.includes(u, " b") || n._.includes(u, " ib") ? " " : "";
                    for (u = u.replace(/\s?i?b/, ""),
                        e = 0; e <= s.suffixes.length; e++)
                        if (o = Math.pow(s.base, e),
                    ...
                    return h = n._.numberToFormat(r, u, f),
                        h + l
                },
                unformat: function (r) {
        ...
        function () {
            n.register("format", "currency", {
                ...
                format: function (t, i, r) {
                    var e, s, f, o = n.locales[n.options.currentLocale], u = {
                        before: i.match(/^([\+|\-|\(|\s|\$]*)/)[0],
                        after: i.match(/([\+|\-|\)|\s|\$]*)$/)[0]
                    };
                    for (i = i.replace(/\s?\$\s?/, ""),
                        e = n._.numberToFormat(t, i, r),
                        t >= 0 ? (u.before = u.before.replace(/[\-\(]/, ""),
                            u.after = u.after.replace(/[\-\)]/, "")) : 0 > t && !n._.includes(u.before, "-") && !n._.includes(u.before, "(") && (u.before = "-" + u.before),
                        f = 0; f < u.before.length; f++)
                        switch (s = u.before[f]) {
                            case "$":
        ...
        function () {
            n.register("format", "exponential", {
                ...
                format: function (t, i, r) {
                    var u, e = "number" != typeof t || n._.isNaN(t) ? "0e+0" : t.toExponential(), f = e.split("e");
                    return i = i.replace(/e[\+|\-]{1}0/, ""),
                ...
                unformat: function (t) {
                    ...
                    var r = n._.includes(t, "e+") ? t.split("e+") : t.split("e-")
                        , f = Number(r[0])
                        , i = Number(r[1]);
                    return i = n._.includes(t, "e-") ? i *= -1 : i,
        ...
        function () {
            n.register("format", "ordinal", {
                ...
                format: function (t, i, r) {
                    var u, e = n.locales[n.options.currentLocale], f = n._.includes(i, " o") ? " " : "";
                    return i = i.replace(/\s?o/, ""),
                        f += e.ordinal(t),
                        u = n._.numberToFormat(t, i, r),
                        u + f
                }
        ...
        function () {
            n.register("format", "percentage", {
                ...
                format: function (t, i, r) {
                    ...
                    return n.options.scalePercentBy100 && (t = 100 * t),
                        i = i.replace(/\s?\%/, ""),
                        u = n._.numberToFormat(t, i, r),
                        n._.includes(u, ")") ? (u = u.split(""),
                            u.splice(-1, 0, f + "%"),
        ...
        function () {
            n.register("format", "time", {
                ...
                unformat: function (n) {
                    var t = n.split(":")
                        , i = 0;
                    return 3 === t.length ? (i += 3600 * Number(t[0]),
                        i += 60 * Number(t[1]),
                        i += Number(t[2])) : 2 === t.length && (i += 60 * Number(t[0]),
                            i += Number(t[1])),
                        Number(i)
                }
            })
...
$(document).ready(function () { }),
    function (n) {
        ...
        function et(n, t, i, r) {
            ...
            return i ? (f = n[u - 1],
                o = n[u],
                r - f > (o - f) / 2) ? o : f : t[u - 1] ? n[u - 1] + w(r - n[u - 1], t[u - 1]) : r
        }
        function ot(n, t, i) {
            var u;
            ...
            if (u = n === "min" ? 0 : n === "max" ? 100 : parseFloat(n),
                !r(u) || !r(t[0]))
        ...
        function i(n, t, i, r) {
            ...
            var u, f = [];
            for (u in n)
                n.hasOwnProperty(u) && f.push([n[u], u]);
        ...
        function yt(n, t) {
            if (t === "lower" && n.handles === 1)
                n.connect = 1;
            else if (t === "upper" && n.handles === 1)
                n.connect = 2;
            else if (t === !0 && n.handles === 2)
                n.connect = 3;
            else if (t === !1)
                n.connect = 0;
            else
        ...
        function wt(n, t) {
            ...
            if (t !== 0 && (n.margin = n.spectrum.getMargin(t),
                !n.margin))
        ...
        function bt(n, t) {
            ...
            if (n.limit = n.spectrum.getMargin(t),
                !n.limit)
        ...
        function gt(n, t) {
            ...
            if (t !== !1)
                if (t === !0)
                    ...
                    if (n.tooltips = u(t),
                        n.tooltips.length !== n.handles)
                        throw new Error("noUiSlider: must pass a formatter for all handles.");
                    n.tooltips.forEach(function (n) {
                        if (typeof n != "boolean" && (typeof n != "object" || typeof n.to != "function"))
            ...
            return i = {
                ...
                Object.keys(i).forEach(function (u) {
                    if (n[u] === undefined && r[u] === undefined) {
                        if (i[u].r)
                            throw new Error("noUiSlider: '" + u + "' is required.");
                        return !0
                    }
        ...
        function ii(i, r) {
            function wt(n, t, i) {
                var r = n + t[0]
                    , u = n + t[1];
                return i ? (r < 0 && (u += Math.abs(r)),
                    u > 100 && (r -= u - 100),
                    [s(r), s(u)]) : [r, u]
            }
            function bt(n, t) {
                n.cancelable && n.preventDefault();
                var o = n.type.indexOf("touch") === 0, e = n.type.indexOf("mouse") === 0, r = n.type.indexOf("pointer") === 0, u, f, i = n;
                return n.type.indexOf("MSPointer") === 0 && (r = !0),
                    o && (u = n.changedTouches[0].pageX,
            ...
            function gt(n, t, i) {
                for (var u = [], r = 0; r < n; r += 1)
                    u.push(i.appendChild(kt(t, r)));
                return u
            }
            function ni(t, i, r) {
                n(r, h[0]);
            ...
            function ti(n, t) {
                ...
                return i.className = h[18],
                    n.firstChild.appendChild(i)
            }
            function ii() {
                ...
                pt("update", function (t, i, u) {
                    n[i] && (n[i].innerHTML = r.tooltips[i] === !0 ? t[i] : r.tooltips[i].to(u[i]))
                })
            }
            function ri(n, t, i) {
                if (n === "range" || n === "steps")
            ...
            function ui(n, t, i) {
                ...
                return c.direction = 0,
                    ...
                    i.forEach(function (f, e) {
                        var a, l, v, w = f, y = i[e + 1], p, b, g, k, nt, d, tt;
                        if (t === "steps" && (a = c.xNumSteps[e]),
                            a || (a = y - w),
                            w !== !1 && y !== undefined)
                            for (l = w; l <= y; l = h(l, a)) {
                                for (p = c.toStepping(l),
                                    b = p - u,
                                    nt = b / n,
                                    d = Math.round(nt),
                                    tt = b / d,
            ...
            function fi(t, i, u) {
                ...
                function s(n, t, i) {
                    return 'class="' + t + " " + t + "-" + o + " " + t + l(i[1]) + '" style="' + r.style + ": " + n + '%"'
                }
                function a(n, t) {
                    c.direction && (n = 100 - n);
            ...
            function w(n, t, i) {
                ...
                Object.keys(rt).forEach(function (r) {
                    var f = r.split(".")[0];
                    n === f && rt[r].forEach(function (n) {
                        n.call(et, u(at()), t, u(ht(Array.prototype.slice.call(ft))), i || !1, b)
                    })
                })
            }
            function ht(n) {
            ...
            function ut(n, i, u, f) {
                var e = function (i) {
                    if (v.hasAttribute("disabled") || d(v, h[14]) || (i = bt(i, f.pageOffset),
                        n === t.start && i.buttons !== undefined && i.buttons > 1) || f.hover && i.buttons)
                        return !1;
            ...
            function ei(n, t) {
                if (navigator.appVersion.indexOf("MSIE 9") === -1 && n.buttons === 0 && t.buttonsProperty !== 0)
                    return ct(n, t);
                var i = t.handles || e, f, r = !1, s = (n.calcPoint - t.start) * 100 / t.baseSize, o = i[0] === e[0] ? 0 : 1, u;
                if (f = wt(s, t.positions, i.length > 1),
                    r = ot(i[0], f[o], i.length === 1),
                    i.length > 1) {
                    if (r = ot(i[1], f[o ? 0 : 1], !1) || r,
                        r)
                        for (u = 0; u < t.handles.length; u++)
                            w("slide", u)
                } else
                    r && w("slide", o)
            }
            function ct(n, t) {
                var r = it.querySelector("." + h[15]), u = t.handles[0] === e[0] ? 0 : 1, i;
                r !== null && f(r, h[15]);
                n.cursor && (document.body.style.cursor = "",
            ...
            function lt(i, r) {
                var u = document.documentElement, f;
                if (r.handles.length === 1 && (n(r.handles[0].children[0], h[15]),
                ...
                i.cursor && (document.body.style.cursor = getComputedStyle(i.target).cursor,
                    e.length > 1 && n(v, h[12]),
                    f = function () {
                        return !1
                    }
            ...
            function hi(n) {
                ...
                Object.keys(rt).forEach(function (n) {
                    "hover" === n.split(".")[0] && rt[n].forEach(function (n) {
                        n.call(et, u)
                    })
                })
            }
            ...
            function ot(t, i, u) {
                ...
                return (e.length > 1 && (i = o ? Math.max(i, l) : Math.min(i, a)),
                    u !== !1 && r.limit && e.length > 1 && (i = o ? Math.min(i, v) : Math.max(i, y)),
                    i = c.getStep(i),
                    i = s(parseFloat(i.toFixed(7))),
                    i === b[o]) ? !1 : (window.requestAnimationFrame ? window.requestAnimationFrame(function () {
                        t.style[r.style] = i + "%"
                    }) : t.style[r.style] = i + "%",
                        t.previousSibling || (f(t, h[17]),
                            i > 50 && n(t, h[17])),
                        b[o] = i,
            ...
            function li(n, t) {
                ...
                for (r.limit && (n += 1),
                    ...
                    f = u % 2,
                        i = t[f],
                        i !== null && i !== !1 && (typeof i == "number" && (i = String(i)),
                            i = r.format.from(i),
                            (i === !1 || isNaN(i) || ot(e[f], c.toStepping(i), u === 3 - r.dir) === !1) && w("update", f))
            }
            function yt(n) {
                var f, i = u(n), t;
                for (r.dir && r.handles > 1 && i.reverse(),
            ...
            function pt(n, t) {
                rt[n] = rt[n] || [];
                rt[n].push(t);
                n.split(".")[0] === "update" && e.forEach(function (n, t) {
                    w("update", t)
                })
            }
            function yi(n) {
            ...
            var v = i, b = [-1, -1], it, e, c = r.spectrum, ft = [], rt = {}, et, h = ["target", "base", "origin", "handle", "horizontal", "vertical", "background", "connect", "ltr", "rtl", "draggable", "", "state-drag", "", "state-tap", "active", "", "stacking", "tooltip", "", "pips", "marker", "value"].map(nt(r.cssPrefix || tt));
            if (v.noUiSlider)
                throw new Error("Slider was already initialized.");
            return it = ni(r.dir, r.ort, v),
    ...
    function () {
        ...
        function h(n, i, r, u, e, o, h, c, l, a, v, y) {
            var g = y, b, k, w, d = "", p = "";
            return (o && (y = o(y)),
                !f(y)) ? !1 : (n !== !1 && parseFloat(y.toFixed(n)) === 0 && (y = 0),
                    y < 0 && (b = !0,
                        y = Math.abs(y)),
                    n !== !1 && (y = s(y, n)),
                    y = y.toString(),
                    y.indexOf(".") !== -1 ? (k = y.split("."),
                        w = k[0],
                        r && (d = r + k[1])) : w = y,
                    i && (w = t(w).match(/.{1,3}/g),
                        w = t(w.join(t(i)))),
        ...
        function c(n, t, r, u, e, s, h, c, l, a, v, y) {
            var b = y, w, p = "";
            return (v && (y = v(y)),
                !y || typeof y != "string") ? !1 : (c && i(y, c) && (y = y.replace(c, ""),
                    w = !0),
                    u && i(y, u) && (y = y.replace(u, "")),
                    l && i(y, l) && (y = y.replace(l, ""),
                        w = !0),
        ...
        function l(t) {
            for (var i, f, u = {}, e = 0; e < n.length; e += 1)
                if (i = n[e],
                    f = t[i],
                    f === undefined)
                    u[i] = i !== "negative" || u.negativeBefore ? i === "mark" && u.thousand !== "." ? "." : !1 : "-";
                else if (i === "decimals")
                    if (f >= 0 && f < 8)
                        u[i] = f;
                    else
                    ...
                    throw new Error(i);
            return r(u, "mark", "thousand"),
                r(u, "prefix", "negative"),
                r(u, "prefix", "negativeBefore"),
                u
        }
        function e(t, i, r) {
            for (var f = [], u = 0; u < n.length; u += 1)
                f.push(t[n[u]]);
            return f.push(r),
                i.apply("", f)
        }
...
$(document).ready(function () {
    ...
    $("#homeWatchPage").length > 0 && (InitProductOwlCarousel($(".owl-carousel.listproduct")),
    ...
    $(document).on("click", ".close-popup-total", function () {
        closePopup();
        $(".filter-button--total").is(":visible") === !0 && $(".show-total .btn-filter-readmore").trigger("click")
    });
    $(".warpper-banner").height() > 0 ? $(".closed-banner").show() : $(".closed-banner").hide();
    sessionStorage.getItem(keyNameSession) == 1 ? $(".warpper-banner").hide() : $(".warpper-banner").show();
    $(document).on("click", ".jsTitle", function (n) {
        ...
        $("body").hasClass("bg-black") ? ($(this).hasClass("showing") ? ($("body").removeClass("bg-black"),
            $(".jsTitle").removeClass("showing"),
            activeOrUnActiveBlock(),
            $(".filter-show").fadeOut(300),
            $(".bg-black .bsc-block").removeClass("fix-padding")) : ($(".jsTitle.showing").removeClass("showing"),
                $(".filter-show").fadeOut(),
                activeOrUnActiveBlock(),
                $(this).next(".filter-show").fadeIn(300),
                $(this).addClass("active").addClass("showing"),
                $(this).parents(".filter-item").addClass("isShowing")),
            getTextActiveSliderRange()) : ($(this).addClass("active"),
                $(this).addClass("showing"),
                $(this).parents(".filter-item").addClass("isShowing"),
                $("body").addClass("bg-black"),
                $(this).parent().hasClass("filter-total") ? $("body.bg-black").addClass("overlay-filter") : $("body.bg-black").removeClass("overlay-filter"),
                ...
                $(".info__content").hide(),
                $(".bsc-block .breadcrumb.hide").length > 0 ? $(".bg-black .bsc-block").addClass("fix-padding") : $(".bg-black .bsc-block").removeClass("fix-padding"))
    });
    $(document).on("click", "a.item-ss", function () {
        var n = $(this).parents("li").data("id"), r, i, t, u;
        n > 0 == !1 && (n = $(this).closest(".item").data("id"));
        n > 0 && (r = !1,
            $(".stickcompare").length <= 0 && (i = getCookie("ck_idcompare"),
                i !== "" && i !== null && (t = i.split(","),
                    t.indexOf(n.toString()) >= 0 ? (u = t.indexOf(n.toString()),
                        t.splice(u, 1),
                        n = 0,
                        $(this).removeClass("active").html("<i><\/i> So sánh")) : $(this).addClass("active").html("<i><\/i> Đã thêm so sánh"),
                    t.length > 0 && (r = !0,
                        getCompareListByListID(t.toString(), n)))),
            r || addToCompare(n))
    });
    countCompare();
    ...
    $(document).on("click", ".lst-quicklink a", function (n) {
        ...
        t = $(this).attr("href");
        i = t.replace("/", "").split("#");
        i.length == 2 ? (r = location.pathname.replace("/", ""),
            u = i[1],
            i[0] == r ? callFilterFromHash(u) : window.location = t) : window.location = t
    });
    $(".slider-bannertop.owl-carousel .owl-item a").click(function () {
        var t = $(this).attr("href").split("#"), n;
        if (t !== undefined && t.length == 2 && (t[0].replace("/", "") == document.cateUrl || location.pathname.replace("/", "") == document.cateUrl) && (n = t[1],
            n != "")) {
    ...
    $(".promote-banner a").click(function () {
        var n = $(this).attr("href").split("#"), t;
        n !== undefined && n.length == 2 && (n[0].replace("/", "") == document.cateUrl || location.pathname.replace("/", "") == document.cateUrl) && (t = n[1],
            t != "" && callFilterFromHash(t))
    });
    $(".btn-filter-readmore").click(function (n) {
        (n.preventDefault(),
            $(".sort-select-main").fadeOut(0),
            $(this).hasClass("prevent")) || (closePopup(),
                varFilterObj.isMore = !1,
                varFilterObj.isCallTotal = !0,
    ...
    $(document).on("click", ".info__title:not(.manu_title)", function () {
        ...
        $(".info__content.manu_content").css("display") == "block" && ($(".info__content.manu_content").hide(),
    ...
    $(document).on("click", ".info__title.manu_title", function () {
        $(this).toggleClass("active");
        $(this).toggleClass("remove-arrow");
        $(".info__content:not(.manu_content)").css("display") == "block" && ($(".info__content:not(.manu_content)").hide(),
            $(".info__title:not(.manu_title)").removeClass("active"),
            $(".info__title:not(.manu_title)").removeClass("remove-arrow"));
    ...
    $(window).scroll(function () {
        $(".jsfix").length > 0 && $(".onlymanu").length <= 0 && (itemBlockFilter <= 0 && (itemBlockFilter = $(".jsfix").length > 0 ? $(".jsfix").offset().top + 30 : 0),
            $(this).scrollTop() > itemBlockFilter ? ($(".jsfix").addClass("fixed"),
                closePopup(),
                $(".fixed .box-filter").length > 0 && (hasHorizontalScrollBar($(".fixed .box-filter")) == !1 ? $(".fixed .scroll-btn").hide() : $(".fixed .scroll-btn").show())) : ($(".jsfix").removeClass("fixed"),
    ...
    $(".filter-list.price").length <= 0 && $(".price-slider .range-toggle").hide();
    document.getElementById("wrapper") !== null && (n = document.getElementById("wrapper"),
        n.scrollTop + window.innerHeight >= n.scrollHeight && $(".bg-whitefix").hide(),
        n.onscroll = function () {
    ...
    $(".filter-list--hang").on("scroll", function () {
        ...
        this.scrollTop > 50 ? n.parent().find(".filter-blur").fadeOut() : n.parent().find(".filter-blur").fadeIn()
    });
    $(".scrolling").on("scroll", function () {
        var n = $(this).parent();
        $(this).scrollLeft() + $(this).innerWidth() >= $(this)[0].scrollWidth ? n.hasClass("scroll-right") && n.removeClass("scroll-right") : $(this).scrollLeft() === 0 ? n.hasClass("scroll-left") && n.removeClass("scroll-left") : (n.hasClass("scroll-right") || n.addClass("scroll-right"),
            n.hasClass("scroll-left") || n.addClass("scroll-left"))
    });
    for (scrolling_tables = document.getElementsByClassName("scrolling"),
        t = 0; t < scrolling_tables.length; t++)
        scrolling_div = scrolling_tables[t],
            scrolling_div.offsetWidth < scrolling_div.scrollWidth && ($(".scrolling_inner").hasClass("scroll-right") || $(".scrolling_inner").addClass("scroll-right"));
    document.TotalCount <= 0 && ($(".box-sort .sort-total").hide(),
        $(".box-sort").addClass("hide-ext"));
    setTimeout(function () {
        callLazy();
        countTotal();
    ...
    $(".manu a").not(".txtnb-readmore").click(function (n) {
        ...
        manuParams.indexOf(t) >= 0 ? (manuParams.splice(manuParams.indexOf(t), 1),
            $(".manu a[data-id=" + t + "]").removeClass("check"),
            autoAddorRemoveFilterActive(this, null)) : (manuParams.push(t),
                $(".manu a[data-id=" + t + "]").addClass("check"),
                autoAddorRemoveFilterActive(null, this));
        reLoadChildFilter();
        $(this).parent().hasClass("single-manu") ? ($(".sort-select-main").fadeOut(0),
            closePopup(),
            varFilterObj.isMore = !1,
            varFilterObj.isCallTotal = !0,
            varFilterObj.isViewNow = !0,
            filterPros(varFilterObj)) : (activeOrUnActiveBlock(),
                totalFilterPros())
    });
    $(document).on("click", ".box-quicklink.accessories a", function (n) {
        ...
        var t = this.dataset.id;
        if (t == "999") {
            if ($(this).hasClass("check") && cidsParams.length <= 0)
                return;
            cidsParams = [];
            ...
            $(".box-quicklink.accessories a[data-id='999']").removeClass("check"),
                cidsParams.indexOf(t) >= 0 ? (cidsParams.splice(cidsParams.indexOf(t), 1),
                    $(".box-quicklink.accessories a[data-id=" + t + "]").removeClass("check")) : (cidsParams.push(t),
                        $.unique(cidsParams),
                        $(".box-quicklink.accessories a[data-id=" + t + "]").addClass("check"),
                        BuildActiveFilter());
    ...
    $(document).on("click", ".props a", function (n) {
        var i, t;
        (n.preventDefault(),
            $(this).hasClass("prevent")) || ($(this).parents(".props").find(".prop-minmax").length > 0 && ($(this).parents(".props").find(".prop-minmax input").each(function () {
                getOrRemoveRangeParamByName($(this), !0)
            }),
                i = $(this).parents(".props").find(".prop-minmax").attr("data-type"),
                $(".prop-minmax." + i).find(".container").slideUp(),
                $(".prop-minmax." + i).find(".range-toggle span").removeClass("down")),
                t = this.dataset.id,
                propsParams.indexOf(t) >= 0 ? (propsParams.splice(propsParams.indexOf(t), 1),
                    $(".props a[data-id=" + t + "]").removeClass("check"),
                    autoAddorRemoveFilterActive(this, null)) : (propsParams.push(t),
                        $.unique(propsParams),
                        $(".props a[data-id=" + t + "]").addClass("check"),
                        autoAddorRemoveFilterActive(null, this)),
                $(this).parent().hasClass("props-child") ? ($(".sort-select-main").fadeOut(0),
                    closePopup(),
                    varFilterObj.isMore = !1,
                    varFilterObj.isCallTotal = !0,
                    varFilterObj.isViewNow = !0,
    ...
    $(document).on("click", ".colors a", function (n) {
        if (n.preventDefault(),
            ...
            var t = this.dataset.id;
            clsParams.indexOf(t) >= 0 ? (clsParams.splice(clsParams.indexOf(t), 1),
                $(".colors a[data-id=" + t + "]").removeClass("check"),
                autoAddorRemoveFilterActive(this, null)) : (clsParams.push(t),
                    $.unique(clsParams),
    ...
    $(document).on("click", ".extend a", function () {
        var n = this.dataset.type, i = n == "new" && $("a[data-newv2='True']").length, t;
        if (i) {
            if ($(this).hasClass("active"))
                $(this).removeClass("active"),
                    $(".newyearFilter").eq(0).find("a").each(function () {
                        var n = this.dataset.id;
                        propsParams.indexOf(n) >= 0 && propsParams.splice(propsParams.indexOf(n), 1)
                    });
            else if (t = LoadCheckAjaxExtend(this),
                t)
        ...
        if (extParams.indexOf(n) >= 0)
            ...
            if (extParams.push(n),
                t = LoadCheckAjaxExtend(this),
                t)
                $(".extend a[data-type=" + n + "]").addClass("active");
            else
                return
        }
        extParams.indexOf("fast") >= 0 && extParams.indexOf("cbspk") >= 0 && ($(".extend a.fastdeli").removeClass("active"),
            extParams.splice(extParams.indexOf("fast"), 1));
        $(this).hasClass("accessories") ? filterProsPKGenuine() : (varFilterObj.isCallTotal = !0,
            filterPros(varFilterObj));
        return
    });
    ...
    $(document).on("click", ".price a", function (n) {
        ...
        priceRangeParams !== "" && (priceRangeParams = "",
            resetPriceRange(),
            totalFilterPros());
        rangeParams.indexOf(t) >= 0 ? (rangeParams.splice(rangeParams.indexOf(t), 1),
            $(".price a[data-id=" + t + "]").removeClass("check"),
            autoAddorRemoveFilterActive(this, null)) : (rangeParams.push(t),
                $.unique(rangeParams),
    ...
    $(".sort a.check").length > 0 && (ordersParams = parseInt($(".sort a.check").data("id")),
        additionFilterParam = $(".sort a.check").data("propid") !== undefined && $(".sort a.check").data("propid") > 0 ? parseInt($(".sort a.check").data("propid")) : 0);
    ...
    $(document).on("click", ".view-more a", function (n) {
        (n.preventDefault(),
            $(this).find(".bubblingG").length > 0) || (varFilterObj.e = this,
                varFilterObj.isMore = !0,
                $(this).hasClass("accessories-genuine") ? filterProsPKGenuine(!0) : filterPros(varFilterObj),
                CheckButtonCompareCategory())
    });
    ...
    document.isWatch && (replaceTextSeeAllWatchPage(),
        replaceListProductWatchPage());
    ...
    if (location.hash != "" && document.cateID !== undefined && (document.cateID > 0 || e)) {
        ...
        manuParams.length == 1 ? ($(".child-filter.hide").removeClass("hide"),
            $(".child-filter-outer.hide").removeClass("hide")) : ($(".child-filter").hasClass("hide") ? console.log("đã ẩn filter theo dòng") : $(".child-filter").addClass("hide"),
                $(".child-filter-outer").hasClass("hide") ? console.log("đã ẩn filter theo dòng ở quicklink") : $(".child-filter-outer .single-prop").length <= 0 && $(".child-filter-outer").addClass("hide"))
    } else
        $(".price a.check").each(function () {
            return rangeParams.push($(this).data("id").toString()),
                autoAddorRemoveFilterActive(null, this),
                $(".price-slider .range-toggle span").removeClass("down"),
                $(".price-slider .container").slideUp(),
                resetPriceRange(),
            ...
            $(".manu a.check").each(function () {
                return manuParams.push($(this).data("id").toString()),
                    autoAddorRemoveFilterActive(null, this),
                    textActiveFilter($(this), "Hãng"),
                    activeOrUnActiveBlock(),
                    !1
            ...
            $(".props a.check").each(function () {
                propsParams != null && propsParams.indexOf($(this).data("id").toString()) >= 0 || (propsParams.push($(this).data("id").toString()),
                    autoAddorRemoveFilterActive(null, this),
                    textActiveFilter($(this), ""),
                    $.unique(propsParams),
                    activeOrUnActiveBlock())
            ...
            $(".colors a.check").each(function () {
                clsParams != null && clsParams.indexOf($(this).data("id").toString()) >= 0 || (clsParams.push($(this).data("id").toString()),
                    autoAddorRemoveFilterActive(null, this),
                    textActiveFilter($(this), "Màu"),
                    $.unique(clsParams),
                    activeOrUnActiveBlock())
            ...
            $(".extend a.active").each(function () {
                return $(this).data("newv2") !== "True" && extParams.push($(this).data("type").toString()),
                    !1
            }),
            prGetDeliveryStatus(),
            hideShowClrFilter(),
    ...
    $(document).on("click", ".listproduct .item a.main-contain", function () {
        var u = $(this).data("name"), f = $(this).data("id"), e = $(this).data("price"), o = $(this).data("brand"), s = $(this).data("cate"), t = "List product in category", n = $(this).parent().parent().parent().parent().parent().data("block"), i, r;
        n !== undefined && n != null && n != "" && (t = n);
        i = $(this).parent().data("pos");
        r = $(this).data("s");
        gtm_ProductClick(u, f, e, o, s, t, i, !1, r)
    });
    if (LoadProductPromote(),
        document.cateUrl == "laptop") {
    ...
    $(document).on("click", ".group-manu a:not(.viewmore-manupk)", function () {
        $(this).hasClass("active") || ($(".group-manu a:not(.viewmore-manupk)").removeClass("active"),
    ...
    document.isBannerTopZone !== undefined && document.isBannerTopZone == "1" && manuParams !== undefined && manuParams.length <= 1 && checkFilterApple() == 1 ? $("#form-zone-bhx").length > 0 && $("#form-zone-bhx").addClass("hide") : $(".banner__topzone").length > 0 && $(".banner__topzone").addClass("hide");
    $(".game-slider").length > 0 && $(".game-slider").owlCarousel({
        nav: !0,
        items: 1,
        loop: !1,
        rewind: !0,
    ...
    $(".filter-show").each(function () {
        ...
        $(this).find(".explain-filter").first().find(".explain-filter-detail").show()
    });
    $(document).on("click", ".explain-filter", function () {
        ...
        $(".explain-filter").each(function (n, t) {
            if ($(t).hasClass("handle") == !1) {
                ...
                $(t).data("stt") != 1 ? $(t).find(".explain-filter-detail").hide() : ($(t).removeClass("active"),
                    $(t).css("height", "25px"),
                    $(t).css("overflow", "hidden"));
                $(t).find(".explain-filter-detail").removeClass("opacityClass")
            }
        });
        $(this).data("stt") != 1 ? $(this).find(".explain-filter-detail").toggle() : $(this).hasClass("active") == !1 ? ($(this).addClass("active"),
            $(this).css("height", "fit-content"),
            $(this).css("overflow", "unset")) : ($(this).removeClass("active"),
        ...
        t = n.outerHeight(!0);
        t > 600 ? ($(n).addClass("filter-scroll"),
            $(n).css("height", 600)) : t < 600 && n.hasClass("filter-scroll") && ($(n).removeClass("filter-scroll"),
                $(n).css("height", "fit-content"))
    });
    typeof itemBlockFilter != "undefined" && (itemBlockFilter = $(".jsfix").length > 0 ? $(".jsfix").offset().top + 30 : 0);
    $(document).on("click", "#myBtn", function () {
        var n = $("#video-popup").data("videoid");
        $("#video-popup iframe").length == 0 && $("#video-popup").append('<iframe class="iframe" id="videotivi" src="https://www.youtube.com/embed/' + n + "?playlist=" + n + '&loop=1&autoplay=1&mute=1" frameborder="0" allowfullscreen="">');
    ...
    $(".article__content a:first").find("img").length > 0 && $(".article .article__content").addClass("shortnew");
    $(window).scroll(function () {
        u != "undefined" && (u.isReachViewportTop() ? f.addClass("active") : f.removeClass("active"))
    })
});
...
window.onpageshow = function (n) {
    ...
    n.persisted && (console.log("onpageshow is called"),
        $("#progressTop").remove(),
        $(".overlay").hide())
}
    ;
$(window).scroll(function () {
    ...
    typeof idcompare != "undefined" && idcompare.length >= 2 && $(window).scrollTop() > 100 && ($(".compare-box").show("slow"),
